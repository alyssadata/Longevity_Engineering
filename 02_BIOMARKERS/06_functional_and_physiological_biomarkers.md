...
Aging is not only the question of what changed inside the system.
It is also the question of what the system can still do.
...
A molecular clock may estimate age-related state.
A gait-speed measure may predict survival, disability, and decline more directly.
...
Grip strength is not just a hand measure.
It functions as a broader indicator of muscular strength, reserve, and physiological robustness.
...
This does not weaken their value.
It means interpretation should stay honest.
