# 01_partial_epigenetic_reprogramming
...
That result did not kill the field.
It clarified the central problem:
...
But removing Myc does not eliminate risk.
...
That means timing, dose, tissue, delivery, and expression control are not implementation details.
They are the intervention boundary itself.

### 3. Tissue-specific toxicity

Whole-body or poorly controlled in vivo expression can produce organ-specific toxicity.

The liver and intestine are especially important cautionary examples from the current literature, but the general principle is broader:
different tissues do not tolerate reprogramming pressure equally.

### 4. Durability uncertainty

Even when molecular or functional benefits appear, durability remains an open question.

How long does the reset hold?
Does benefit require repeated intervention?
Does repeated intervention increase risk?

These are not resolved.

### 5. Heterogeneous tissue response

Some tissues may benefit more than others.
Some may resist reprogramming.
Some may incur more risk than benefit.
...
This is not an intervention class that fails for lack of excitement.
It fails or succeeds on control.
